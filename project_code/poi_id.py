...
'''to try out any of the above classifiers, reset clf at line 126 to the 
...
'''to get the best parameters of GridSearchCV, set clf = clf8 at line 126,and 
run this file. Then write 'print clf.best_params_' at 
line 103 of tester.py and run'''
